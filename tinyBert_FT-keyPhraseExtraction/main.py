...
tokenizer = AutoTokenizer.from_pretrained("./keywordsGeneration-model")
model = AutoModelForTokenClassification.from_pretrained("./keywordsGeneration-model")
...
async def generate_keyphrases(input_text: TextInput):
    ...
    keyphrases = final_keywords_instance.generate_final_keywords(input_text.text)
